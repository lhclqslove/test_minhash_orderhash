#ifndef DE8B470D_E48E_48C7_809A_B4368CEC172C_order
#define DE8B470D_E48E_48C7_809A_B4368CEC172C_order
 ...
 */
    ...
    public:
        ...
        void string2Sketch(const std::string &s, kMer_t *sketch,
                           std::vector<mer_info> &kMers, std::vector<kMer_t> &hashes);
...
//                             std::vector<kMer_t> &kMers);
        static void string2KMers(const std::string &s, const size_t k, std::vector<mer_info> &KMers_info);
